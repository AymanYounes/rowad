                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-block">
                                    ...
                                    <form method="post" action="{{route('updateProductCategory',$category->id)}}">
                                        @csrf
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label" for="name_en">Name En</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="name_en" id="name_en" class="form-control" value="{{($category->name_en)?$category->name_en:''}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label" for="name_ar">Name Ar</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="name_ar" id="name_ar" class="form-control" value="{{($category->name_ar)?$category->name_ar:''}}">
                                            </div>
                                        </div>

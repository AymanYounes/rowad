                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <form method="post" action="{{route('updateProduct',$product->id)}}" enctype="multipart/form-data">
                                            ...
                                            @if($product->image)
                                                <img src="{{asset('images/products/'.$product->image)}}" width="150" height="150" alt="">
                                            @endif
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="title_en" id="title_en" class="form-control" value="{{($product->title_en)?$product->title_en:''}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label" for="title_ar">Title Ar</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="title_ar" id="title_ar" class="form-control" value="{{($product->title_ar)?$product->title_ar:''}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label" for="description_en">description En</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="description_en" id="description_en" class="form-control" value="{{($product->description_en)?$product->description_en:''}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label" for="description_ar">description Ar</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="description_ar" id="description_ar" class="form-control" value="{{($product->description_ar)?$product->description_ar:''}}">
                                                </div>
                                            </div>
